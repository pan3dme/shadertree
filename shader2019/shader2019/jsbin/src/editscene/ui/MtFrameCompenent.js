...
var materialui;
(function (materialui) {
    var FrameCompenent = Pan3d.FrameCompenent;
    var Scene_data = Pan3d.Scene_data;
    var MtFrameCompenent = /** @class */ (function (_super) {
        __extends(MtFrameCompenent, _super);
        function MtFrameCompenent() {
            return _super.call(this) || this;
        }
        MtFrameCompenent.prototype.applyAbsolutePoint = function () {
            if (this.parent) {
        ...
        return MtFrameCompenent;
    }(FrameCompenent));
    materialui.MtFrameCompenent = MtFrameCompenent;
})(materialui || (materialui = {}));
//# sourceMappingURL=MtFrameCompenent.js.map