    ...
    export class CompileTwo {
      ...
      //  public static TEX_CUBE: string = "cube";
        ...
        public processOpNode($node: NodeTree): void {
            ...
            var skyboxInput: NodeTreeInputItem = $node.inputVec[9];
            ...
            if (skyboxInput.parentNodeItem) {//天空盒
                var pNodeSkyBox: NodeTreeTex = <NodeTreeTex>skyboxInput.parentNodeItem.node;// 
                if (pNodeSkyBox) {
                    skyboxInput.hasCompiled = true;
                    pNodeSkyBox.releaseUse();
                }
            }  
