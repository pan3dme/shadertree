module materialui {
    ...
    export class BaseMaterialNodeUI extends MtUiPanel {
        ...
        public constructor() {
            ...
            this._labelRender.uiAtlas = BaseMaterialNodeUI.baseUIAtlas;
            this._topRender.uiAtlas = BaseMaterialNodeUI.baseUIAtlas;


            this._container = new PanelContainer(this, this._labelRender, this._topRender);
            this.loadConfigCom();
        }
        ...
        public static titleFrameId: number = 0
        ...
        private onMove($e: InteractiveEvent): void {
            this.left = this.lastPanelPos.x + ($e.x - this.mouseXY.x) / MtlUiData.Scale;
            this.top = this.lastPanelPos.y + ($e.y - this.mouseXY.y) / MtlUiData.Scale;
            this.resize();
            this.drawLine();
        }
