...
module Pan3d {
    export class UIAtlas {
        ...
        public updateLable($key: string, $str: string, fontsize: number, fontColor: string,
            textBaseline: CanvasTextBaseline = TextAlign.MIDDLE, textAlign: CanvasTextAlign = TextAlign.CENTER, bolder: boolean = false, maxWidth: number = 0): void {
        ...
        public updateLableCtx($ctx: CanvasRenderingContext2D, $str: string, $x: number, $y: number, $fontsize: number
            , $textAlign: CanvasTextAlign = TextAlign.CENTER
            , $textBaseline: CanvasTextBaseline = TextAlign.MIDDLE
        ...
        public getTextCtx($rec: UIRectangle, $fontsize: number, $fontColor: string, $bolder: boolean, $textBaseline: CanvasTextBaseline
            , $textAlign: CanvasTextAlign): CanvasRenderingContext2D {
